...
def test_trained_agent():
    ...
    try:
        model.load_state_dict(torch.load("snn_basic_model_local.pth", weights_only=True))
        print("Successfully loaded 'snn_basic_model_local.pth'!")
    except FileNotFoundError:
        print("ERROR: Could not find 'snn_basic_model_local.pth'. Please run 'parallel_train.py' first.")
        return
